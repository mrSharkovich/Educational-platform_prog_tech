...
| Роль | Логин | Пароль | Курсы |
|------|-------|--------|-------|
| Преподаватель | `t1` | `1` | Open Course 1, Closed Course 1 |
| Студент | `st1` | `1` | Open Course 1 |
| Студент | `st2` | `2` | Closed Course 1 |

Каждый курс: Блок 1 → Урок 1 + Развёрнутый ответ + Краткий ответ (верный: `123`) + Тест (верный: `2`).
